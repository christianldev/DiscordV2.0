	...
	return (
		<div
			...
			<div
				...
				/>
				<div className=" pl-2">
					<p className="text-xs">Anonimous</p>
			...
			<div className=" flex space-x-2 text-[16px]">
				...
				<svg
					...
					<path
                        ...
                        83.421 480 144 480h24c13.255 0 24-10.745 24-24V280c0-13.255-10.745-24-24-24h-24c-31.342 0-59.671
                         ...
                         111.928-108.187l14.382-7.191A32 32 0 0 0 512 336v-48c0-141.479-114.496-256-256-256z"></path>
				</svg>
				<svg
					stroke="currentColor"
					fill="currentColor"
                ...
                13.518L96.97 235.2c0 7.282-1.06 13.518-1.06 20.8s1.06 13.518 1.06 20.8l-44.668 34.318c-4.26 3.118-5.318
                 ...
                 0-74.46-32.235-74.46-72.8s32.971-72.8 74.46-72.8 74.461 32.235 74.461 72.8-32.972 72.8-74.461 72.8z"></path>
				</svg>
			</div>
			{showModal ? (
				<ModalStructure
