...
export const wrapperClasses = {
	...
	warning:
		'bg-orange-100 dark:bg-orange-800 dark:text-orange-100',
	error:
		'bg-indigo-800 dark:bg-indigo-800 dark:text-red-100',
};
// RequiredToastProps prevents Type Error
export const iconClasses = {
	info: 'dark:bg-blue-100 bg-blue-500 text-white dark:text-blue-500',
	success:
		'dark:bg-green-100 bg-green-500 text-white dark:text-green-500',
	warning:
		'dark:bg-orange-100 bg-orange-500 text-white dark:text-orange-500',
	error: 'dark:bg-black bg-black text-white',
};

export const closeButtonClasses =
	'w-4 h-4 mx-3 items-center justify-center text-white rounded-md inline-flex';
